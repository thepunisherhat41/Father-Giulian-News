...
test('current edition is healthy on mobile card by card', async ({ page }) => {
  ...
  for(const required of [
    ...
    'qr code',
    '8 semanas hoje',
    'bombeiros resgatam 20 pessoas',
    'presidenciáveis cumprem agendas de domingo',
    'santos vence o corinthians por 1 a 0 em itaquera',
    'resultado final',
    'christian oliva',
  ...
  for(const omitted of [
    ...
    'santos abre 1 a 0 sobre o corinthians',
    'jogo em andamento',
