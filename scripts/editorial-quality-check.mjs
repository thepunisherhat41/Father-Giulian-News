...
if(!/slug:'appsec-ssdlc',state:'(?:VALIDADO|ATUALIZADO)'/.test(freshness))failures.push('Freshness: AppSec deve estar VALIDADO sem fato novo ou ATUALIZADO quando houver advisory confirmado da data corrente.');
