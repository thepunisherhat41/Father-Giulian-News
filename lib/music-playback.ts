...
const trackIds: Record<string, string> = {
  ...
  [key('Soundgarden', 'Fell on Black Days')]: '2AAO0bpq6Fad0jNSekFs8G',
  [key('Chris Cornell', 'Seasons')]: '4QglwXpVgc088RhQOp42vx',
  [key('Alice In Chains', 'Nutshell')]: '2JuasWPUodaUxf5nwNpciQ',
  [key('Stone Temple Pilots', 'Interstate Love Song')]: '1AfYo6cKm3yHsJHdmNoGO1',
  [key('Avenged Sevenfold', 'So Far Away')]: '1SeO0jNtX6Z51zbatZVeYG',
