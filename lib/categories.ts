...
export const categories: Category[] = [
  ...
  { slug: 'games', label: 'Games', emoji: '🎮', description: 'Lançamentos, retrô, gameplay, indústria, hardware, e-sports e histórias de jogos que merecem contexto.', subcategories: ['Lançamentos', 'PlayStation 5: recursos confirmados', 'Nintendo Switch 2: o que vale acompanhar', 'Retrô', 'Game Design', 'Indies', 'Hardware', 'E-sports', 'Trilhas', 'Vale acompanhar?'] },
