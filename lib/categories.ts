...
export const categories: Category[] = [
  ...
  { slug: 'games', label: 'Games', emoji: '🎮', description: 'Lançamentos, retrô, gameplay, indústria, hardware, e-sports e histórias de jogos que merecem contexto.', subcategories: ['Lançamentos', 'Retrô', 'Game Design', 'Indies', 'Hardware', 'E-sports', 'Trilhas', 'Vale acompanhar?'] },
