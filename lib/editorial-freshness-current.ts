...
export const editorialFreshness: EditorialFreshnessEntry[] = [
  ...
  { slug:'curiosidades', state:'ATUALIZADO', validatedAt:editorialFreshnessValidatedAt, note:'A rotação foi corrigida após comparação da janela recente: os conceitos que ciclariam em menos de sete dias foram substituídos hoje por três curiosidades inéditas — Ciência, Psicologia e Tecnologia — com fontes novas e fallback visual específico.' },
