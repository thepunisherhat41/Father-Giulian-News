...
export const editorialFreshnessValidatedAt='07/09/2026 · 08h10 · atualização intradiária';
...
{slug:'seguranca-zl',state:'VALIDADO',validatedAt:editorialFreshnessValidatedAt,note:'Nenhum fato novo datado de 07/09 localizado na Subprefeitura de São Miguel Paulista até 08h10; Reel omitido.'},
{slug:'politica',state:'VALIDADO',validatedAt:editorialFreshnessValidatedAt,note:'Sem confirmação de fato político novo iniciado em 07/09 que justifique card até 08h10. Reel omitido.'},
...
{slug:'games',state:'VALIDADO',validatedAt:editorialFreshnessValidatedAt,note:'Sem anúncio material novo datado de 07/09 confirmado em fonte oficial adequada até 08h10; Reel omitido.'},
...
{slug:'corinthians',state:'VALIDADO',validatedAt:editorialFreshnessValidatedAt,note:'Resultado de 2 a 1 para a Chapecoense ocorreu em 06/09 e já foi publicado na edição anterior; sem fato novo do Corinthians iniciado em 07/09 até 08h10. Reel omitido.'},
...
{slug:'appsec-ssdlc',state:'VALIDADO',validatedAt:editorialFreshnessValidatedAt,note:'Sem CVE/advisory AppSec novo de 07/09 com confirmação oficial suficiente até 08h10; Reel omitido.'}
];
