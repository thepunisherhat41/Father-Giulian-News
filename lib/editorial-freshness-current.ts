...
export const editorialFreshnessValidatedAt='12/09/2026 · 20h32 · atualização da noite';
export const editorialFreshness:EditorialFreshnessEntry[]=[
{slug:'brasil',state:'VALIDADO',validatedAt:editorialFreshnessValidatedAt,note:'Nenhum fato Brasil material surgido em 12/09 foi confirmado neste corte da noite; conteúdo de 11/09 não foi reciclado.'},
...
{slug:'tecnologia',state:'ATUALIZADO',validatedAt:editorialFreshnessValidatedAt,note:'DECLARAÇÃO 12/09: Reuters publicou às 20h38 UTC (17h38 BRT) que Sam Altman descartou IPO da OpenAI em 2026 por preocupações de segurança e alinhamento. Ele também sinalizou que empresas líderes podem estar perto de um pacto para desacelerar o desenvolvimento; o acordo não foi anunciado nem formalizado.'},
...
{slug:'seguranca',state:'VALIDADO',validatedAt:editorialFreshnessValidatedAt,note:'As declarações de executivos de IA têm implicações de segurança, mas foram classificadas em Tecnologia; nenhum incidente Cyber novo da data foi promovido sem confirmação própria.'},
