...
export const editorialFreshnessValidatedAt='02/09/2026 · 17h45 · revisão intradiária';
...
{slug:'politica',state:'ATUALIZADO',validatedAt:editorialFreshnessValidatedAt,note:'FATO · ATUALIZAÇÃO: comissão mista aprovou em 02/09 o relatório da MP 1.357/2026; o texto segue ao Plenário da Câmara e, se aprovado, depois ao Senado. A aprovação na comissão não é apresentada como aprovação final do Congresso.'},
