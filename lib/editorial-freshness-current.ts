...
export const editorialFreshnessValidatedAt='18/09/2026 · 11h45 · corte da manhã';
...
{slug:'politica',state:'VALIDADO',validatedAt:editorialFreshnessValidatedAt,note:'Agenda política de 18/09 só entra quando sustentada por fonte datada; compromissos passados não são presumidos como realizados.'},
{slug:'planeta',state:'VALIDADO',validatedAt:editorialFreshnessValidatedAt,note:'Coleção evergreen; exige rotação distinta dos sete dias anteriores.'},
{slug:'animais',state:'VALIDADO',validatedAt:editorialFreshnessValidatedAt,note:'Coleção evergreen; exige rotação distinta dos sete dias anteriores.'},
...
{slug:'seguranca-zl',state:'ATUALIZADO',validatedAt:editorialFreshnessValidatedAt,note:'ATUALIZAÇÃO 18/09: protesto afetou parcialmente a Linha 12-Safira entre São Miguel Paulista e Comendador Ermelino pela manhã; publicação datada de hoje.'},
{slug:'corinthians',state:'ATUALIZADO',validatedAt:editorialFreshnessValidatedAt,note:'FATO 18/09: Corinthians lançou terceira camisa azul; ATUALIZAÇÃO: desempenho pós-Copa caiu a 35,5% e diretoria mantém Fernando Diniz.'},
{slug:'curiosidades',state:'VALIDADO',validatedAt:editorialFreshnessValidatedAt,note:'Rotação de 18/09 deve permanecer distinta dos conceitos usados nos sete dias anteriores.'},
...
{slug:'games',state:'VALIDADO',validatedAt:editorialFreshnessValidatedAt,note:'Sem fato novo de 18/09 confirmado neste corte; não reciclar manutenção de 17/09.'},
...
{slug:'financas',state:'VALIDADO',validatedAt:editorialFreshnessValidatedAt,note:'Sem fechamento de mercado de 18/09 neste corte; números de 17/09 não são reciclados como atuais.'},
...
{slug:'carros',state:'VALIDADO',validatedAt:editorialFreshnessValidatedAt,note:'Conteúdo deve respeitar teto absoluto de R$70 mil.'},
