...
set('mundo', {
  ...
  sources: [{ label: 'Reuters · sanções ao Irã · 25/08/2026', url: 'https://www.reuters.com/world/china/global-markets-global-markets-2026-08-25/' }],
});
...
updateDrop('mundo', { title: 'Irã promete resposta após novas sanções dos EUA', detail: 'O pacote elevou a tensão, mas ficou abaixo do cenário mais severo que parte do mercado temia.' });
updateDrop('financas', { title: 'Yields cedem; petróleo oscila; Nvidia vira próximo teste', detail: 'Mercados de 25/08 equilibram dívida americana, energia e expectativa por IA.' });
updateDrop('tecnologia', { title: 'Nvidia vira teste para o ciclo de infraestrutura de IA', detail: 'Investidores querem sinais de demanda, capex e retorno da expansão de data centers.' });
